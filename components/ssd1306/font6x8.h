...
/**
 * @file font6x8.h
 * @brief 6x8 ASCII 点阵字库 (可打印字符 0x20..0x7E)。
 *
 * 每个字符 6 列, 列优先存储: 每字节代表一列的 8 个像素,
 * bit0 = 顶行, bit7 = 底行 (仅用低 7 位, 5x7 字形 + 右侧 1 列间距)。
 */

#define FONT6X8_FIRST_CHAR 0x20
#define FONT6X8_LAST_CHAR  0x7E
#define FONT6X8_WIDTH      6
#define FONT6X8_HEIGHT     8

static const uint8_t font6x8[FONT6X8_LAST_CHAR - FONT6X8_FIRST_CHAR + 1][FONT6X8_WIDTH] = {
